...
**Last updated:** 2026-06-07 (M3 readiness — Gates 1–9 Ready; spike plan added)
...
| **Selected next lane** | **[Model download / GGUF UX](./qwon_model_download_gguf_ux_plan.md)** — M1/M2 complete; M3 Gates **1–9 Ready** · [spike plan](./qwon_m3_spike_plan.md) added |
| **M3 readiness** | Gates **1–9** evidence memos linked from [checklist](./qwon_model_download_gguf_ux_plan.md#m3-readiness-gate-checklist) — Gates **1–9 Ready** · [queue status](./qwon_next_work_queue.md#m3-readiness-status-2026-06-05) |
...
| **Can we start M3 in-app download?** | **After spike plan merge only** — use [M3 spike plan](./qwon_m3_spike_plan.md); compile-gated implementation only, no Build `4` |
...
| [qwon_model_download_gguf_ux_plan.md](./qwon_model_download_gguf_ux_plan.md) | **Second post-alpha scoped plan** — M1/M2 complete; [M3 checklist](./qwon_model_download_gguf_ux_plan.md#m3-readiness-gate-checklist) Gates **1–9 Ready** |
| [qwon_m3_spike_plan.md](./qwon_m3_spike_plan.md) | **M3 implementation boundary** — compile-gated in-app download spike plan; Build `4` remains separate |
