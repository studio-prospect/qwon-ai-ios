...
**Last updated:** 2026-06-06 (M3 readiness — Gates 1–5 Ready; Gates 6–9 Pending)
...
| **Selected next lane** | **[Model download / GGUF UX](./qwon_model_download_gguf_ux_plan.md)** — M1/M2 complete; M3 Gates **1–5 Ready**, Gates **6–9 Pending** · spike **not open** |
| **M3 readiness** | Gates **1–9** evidence memos linked from [checklist](./qwon_model_download_gguf_ux_plan.md#m3-readiness-gate-checklist) — Gates **1–5 Ready**, Gates **6–9 Pending** · [queue status](./qwon_next_work_queue.md#m3-readiness-status-2026-06-05) |
...
| [qwon_model_download_gguf_ux_plan.md](./qwon_model_download_gguf_ux_plan.md) | **Second post-alpha scoped plan** — M1/M2 complete; [M3 checklist](./qwon_model_download_gguf_ux_plan.md#m3-readiness-gate-checklist) Gates **1–5 Ready**, Gates **6–9 Pending** |
