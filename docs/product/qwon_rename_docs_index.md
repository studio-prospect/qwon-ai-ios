...
**Last updated:** 2026-06-03 (UI polish / onboarding — first post-alpha lane selected)
...
**Post-alpha option lanes (v0.2+ planning):** [qwon_post_alpha_options.md](./qwon_post_alpha_options.md) — **selected first lane:** [UI polish / onboarding](./qwon_post_alpha_options.md#product-lane-decision) (planning only; build **`4` not approved**)
...
| **Current next lane (planning)** | **[UI polish / onboarding](./qwon_post_alpha_options.md#product-lane-decision)** — selected; **Codex scoped plan next**; implementation **not approved** |
...
| **Which post-alpha lane should product pick?** | **Decided** — [UI polish / onboarding](./qwon_post_alpha_options.md#product-lane-decision); deferred lanes in [selection matrix](./qwon_post_alpha_options.md#selection-matrix) |
