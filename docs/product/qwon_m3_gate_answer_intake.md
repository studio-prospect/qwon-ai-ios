...
| **Gates 6–9** | **Pending** — this ledger does not approve downstream gates |
...
**Ready sign-off:** Gate **1** is **Ready** as part of Batch A sign-off. Gates **4–5** are now Ready as part of Batch B sign-off; Gates **6–9** remain **Pending**.
