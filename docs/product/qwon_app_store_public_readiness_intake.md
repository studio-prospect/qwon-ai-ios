...
**G6 worksheet (This PR):** **Working Draft / Awaiting Product + Legal answers** — **Q-AS-13 … Q-AS-15** remain **Unanswered**; checklist gate **G6** remains **Open**. Gate sign-off follows confirmed intake answers in a **separate docs-only PR**. **Not** public release, Build `4`, or ASC submission approval.
