...
| **G5 intake** | **Q-AS-11 … Q-AS-12 Answered** ([#149](https://github.com/studio-prospect/qwon-ai-ios/pull/149)) — checklist gate **G5 Open** ([gate sign-off Pending](./qwon_app_store_g5_gate_signoff_worksheet.md#sign-off-record-legal-product)) |
...
**G5 intake (2026-06-08):** **Q-AS-11 … Q-AS-12 Answered** ([#149](https://github.com/studio-prospect/qwon-ai-ios/pull/149)). Checklist gate **G5 Open** — [gate sign-off worksheet](./qwon_app_store_g5_gate_signoff_worksheet.md#sign-off-record-legal-product) **Pending** (This PR). **Not** final model distribution policy approval. **Not** in-app download / M3 reopen / hosted distribution / bundled weights. **Not** G5 Closed/Ready, public release, Build `4`, or ASC submission approval.
...
**Scope (This PR):** Recorded **Answered** intake rows only; **G5 gate sign-off** remains **Open** — separate sign-off worksheet follows.
