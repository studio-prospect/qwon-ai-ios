...
**Last updated:** 2026-06-08 (Stay selected — G5 intake **Q-AS-11 … Q-AS-12 Answered**; gate sign-off **Open**)
...
| **G5 intake** | **Q-AS-11 … Q-AS-12 Answered** (This PR) — checklist gate **G5 Open** (gate sign-off pending) |
...
**G5 intake (2026-06-08):** **Q-AS-11 … Q-AS-12 Answered** (This PR). Checklist gate **G5 Open** — gate sign-off pending. **Not** final model distribution policy approval. **Not** in-app download / M3 reopen / hosted distribution / bundled weights. **Not** G5 Closed/Ready, public release, Build `4`, or ASC submission approval.

| Question ID | Gate | Owner | Question | Answer status | Answer source | Blocks | Follow-up PR |
| --- | --- | --- | --- | --- | --- | --- | --- |
| Q-AS-11 | G5 | Legal, Product | What is the approved **public model distribution policy** — Mac+USB **Place GGUF via Mac** only, in-app download, bundled weights, or a phased combination? | Answered | [G5 worksheet — Legal/Product decision draft § Q-AS-11](./qwon_app_store_g5_model_distribution_worksheet.md#q-as-11--public-model-distribution-policy) | — | This PR |
| Q-AS-12 | G5 | Legal | What **license and redistribution constraints** (e.g. bartowski GGUF, QWON-hosted mirror) must be documented for App Review and user-facing copy? | Answered | [G5 worksheet — Legal/Product decision draft § Q-AS-12](./qwon_app_store_g5_model_distribution_worksheet.md#q-as-12--license-and-redistribution-constraints) | G5 sign-off | This PR |
...
| **G5** | Open | Q-AS-11 … Q-AS-12 | **Yes** — intake **Answered** (This PR); gate sign-off still **Open** · [worksheet](./qwon_app_store_g5_model_distribution_worksheet.md#legal-product-decision-draft--awaiting-explicit-approval) |
...
This ledger is **Stay-allowed docs hygiene**. Maintain question text and links only unless Product/Legal/RE supplies answers. **G5 intake Answered** (This PR) does **not** mark **G5 Closed/Ready**. Do **not** mark **G6–G10 Closed/Ready**, reopen M3, or approve public release from intake recording alone.
