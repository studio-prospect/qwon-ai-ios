...
**Last updated:** 2026-06-08 (Stay selected — G3 gate sign-off worksheet added; gate **Open**)
...
| **External worksheets** | [G1 gate sign-off](./qwon_app_store_g1_gate_signoff_worksheet.md) — **Approved** 2026-06-08 ([#131](https://github.com/studio-prospect/qwon-ai-ios/pull/131)); checklist gate **G1 Closed/Ready** · [G2 gate sign-off](./qwon_app_store_g2_gate_signoff_worksheet.md#sign-off-record-product) — **Approved** 2026-06-08 ([#136](https://github.com/studio-prospect/qwon-ai-ios/pull/136)); checklist gate **G2 Closed/Ready** · [G3 gate sign-off](./qwon_app_store_g3_gate_signoff_worksheet.md#sign-off-record-legal) — **Pending** (This PR) · [G3 privacy worksheet](./qwon_app_store_g3_privacy_worksheet.md#legal-product-decision-draft--awaiting-explicit-approval) — **approved for intake recording** ([#139](https://github.com/studio-prospect/qwon-ai-ios/pull/139)) · [G1 Product worksheet](./qwon_app_store_g1_product_worksheet.md) |
...
| **G3 intake** | **Q-AS-07 … Q-AS-08 Answered** ([#139](https://github.com/studio-prospect/qwon-ai-ios/pull/139)) — checklist gate **G3 Open** · [gate sign-off worksheet](./qwon_app_store_g3_gate_signoff_worksheet.md#sign-off-record-legal) **Pending** |
...
**G3 intake (2026-06-08):** **Q-AS-07 … Q-AS-08 Answered** ([#139](https://github.com/studio-prospect/qwon-ai-ios/pull/139)). Legal / Product approval recorded from [G3 worksheet — approved for intake recording](./qwon_app_store_g3_privacy_worksheet.md#legal-product-decision-draft--awaiting-explicit-approval) ([#138](https://github.com/studio-prospect/qwon-ai-ios/pull/138) worksheet prep). Checklist gate **G3** remains **Open** — [gate sign-off worksheet](./qwon_app_store_g3_gate_signoff_worksheet.md#sign-off-record-legal) **Pending** (This PR). **Not** final ASC privacy label publish, public release, Build `4`, or ASC submission approval.
...
| **G3** | Open | Q-AS-07 … Q-AS-08 | **Yes** — intake **Answered** ([#139](https://github.com/studio-prospect/qwon-ai-ios/pull/139)); **gate sign-off Pending** · [worksheet](./qwon_app_store_g3_gate_signoff_worksheet.md#sign-off-record-legal) |
...
This ledger is **Stay-allowed docs hygiene**. Maintain question text and links only unless Product/Legal/RE supplies answers. **G3 gate sign-off worksheet added** (This PR) does **not** mark checklist gate **G3 Closed/Ready** or publish ASC privacy labels. Do **not** mark **G4–G10 Closed/Ready** or approve public release from worksheet creation alone.
