...
**Last updated:** 2026-06-08 (Stay selected — G4 gate sign-off worksheet added; gate **Partial**)
...
**G4 intake (2026-06-08):** **Q-AS-09 … Q-AS-10 Answered** ([#144](https://github.com/studio-prospect/qwon-ai-ios/pull/144)). Legal / RE approval recorded from [G4 worksheet — approved for intake recording](./qwon_app_store_g4_export_compliance_worksheet.md#legal-re-decision-draft--awaiting-explicit-approval) ([#143](https://github.com/studio-prospect/qwon-ai-ios/pull/143) worksheet prep). Checklist gate **G4** remains **Partial** — [gate sign-off worksheet](./qwon_app_store_g4_gate_signoff_worksheet.md#sign-off-record-legal-re) **Pending** (This PR). **Not** export compliance final submission, public release, Build `4`, or ASC submission approval.
...
| **G4** | Partial | Q-AS-09 … Q-AS-10 | **Yes** — intake **Answered** ([#144](https://github.com/studio-prospect/qwon-ai-ios/pull/144)); **gate sign-off Pending** · [worksheet](./qwon_app_store_g4_gate_signoff_worksheet.md#sign-off-record-legal-re) |
...
This ledger is **Stay-allowed docs hygiene**. Maintain question text and links only unless Product/Legal/RE supplies answers. **G4 gate sign-off worksheet added** (This PR) does **not** mark checklist gate **G4 Closed/Ready** or submit export compliance. Do **not** mark **G5–G10 Closed/Ready** or approve public release from worksheet creation alone.
