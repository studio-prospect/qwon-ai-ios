...
| **4** | **App Store public release readiness** | Long-term exit from TestFlight-only — checklist only | [App Store readiness](./qwon_post_alpha_options.md#5-public--app-store-readiness) | **Separate** from Build `4`; product horizon gate |
