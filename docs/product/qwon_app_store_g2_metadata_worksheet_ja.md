...
**最終更新:** 2026-06-22（G2 historical intake source — **Q-AS-04 … Q-AS-06 Answered** は [#134](https://github.com/studio-prospect/qwon-ai-ios/pull/134)；現在の gate sign-off は [#136](https://github.com/studio-prospect/qwon-ai-ios/pull/136) で **Closed/Ready**）
**状態:** **Historical intake worksheet** — [intake ledger](./qwon_app_store_public_readiness_intake.md) の **Q-AS-04 … Q-AS-06** を **Answered** に記録（[#134](https://github.com/studio-prospect/qwon-ai-ios/pull/134)）。現在の checklist gate **G2** は [G2 gate sign-off worksheet](./qwon_app_store_g2_gate_signoff_worksheet.md#sign-off-record-product)（[#136](https://github.com/studio-prospect/qwon-ai-ios/pull/136)）で **Closed/Ready**。**App Store 公開承認ではない**。**Build `4` 承認ではない**。**TestFlight upload / tag / version bump 承認ではない**。
**目的:** Product が **G2 — App Store メタデータ / スクリーンショット / ローカライズ** の 3 問に記入した historical intake source。現在の gate 判断は [G2 gate sign-off](./qwon_app_store_g2_gate_signoff_worksheet.md#sign-off-record-product)（[#136](https://github.com/studio-prospect/qwon-ai-ios/pull/136)）を正本とする。
...
**履歴ソース注記:** 本 worksheet は G2 intake [#134](https://github.com/studio-prospect/qwon-ai-ios/pull/134) の **historical intake source** です。現在の gate 判断の正本は [G2 gate sign-off worksheet](./qwon_app_store_g2_gate_signoff_worksheet.md#sign-off-record-product)（[#136](https://github.com/studio-prospect/qwon-ai-ios/pull/136)）で、checklist gate **G2** は **Closed/Ready** です。worksheet 当時の gate 状態は下記で **historical at worksheet time** と明示します。
...
| **記録** | Product **intake 記録承認済**（2026-06-08）— intake **Answered**（[#134](https://github.com/studio-prospect/qwon-ai-ios/pull/134)）；historical at worksheet time: sign-off 前は **Open**；現在は **G2 Closed/Ready**（[#136](https://github.com/studio-prospect/qwon-ai-ios/pull/136)） |
...
**ラベル:** **Product decision draft — intake 記録承認済（2026-06-08）** — [intake ledger](./qwon_app_store_public_readiness_intake.md#g2-product-answer-details-2026-06-08) に記録（[#134](https://github.com/studio-prospect/qwon-ai-ios/pull/134)）。historical at worksheet time: **G2 Closed/Ready ではない**；現在は **G2 Closed/Ready**（[#136](https://github.com/studio-prospect/qwon-ai-ios/pull/136)）。**公開承認ではない**。**承認済み App Store 文案 / ASC upload ではない**。
...
| **Gate sign-off** | **Done** — [G2 gate sign-off worksheet](./qwon_app_store_g2_gate_signoff_worksheet.md#sign-off-record-product) で checklist **Closed/Ready** を記録（[#136](https://github.com/studio-prospect/qwon-ai-ios/pull/136)） |
...
| **制約** | **承認済み App Store 文案ではない**；intake **Answered**（[#134](https://github.com/studio-prospect/qwon-ai-ios/pull/134)）；historical at worksheet time: sign-off 前は **Open**；現在は **G2 Closed/Ready**（[#136](https://github.com/studio-prospect/qwon-ai-ios/pull/136)） |
...
| **制約** | ASC screenshot upload なし；intake **Answered**（[#134](https://github.com/studio-prospect/qwon-ai-ios/pull/134)）；historical at worksheet time: sign-off 前は **Open**；現在は **G2 Closed/Ready**（[#136](https://github.com/studio-prospect/qwon-ai-ios/pull/136)） |
...
| **制約** | ローカライズ資産の作成/upload 承認ではない；intake **Answered**（[#134](https://github.com/studio-prospect/qwon-ai-ios/pull/134)） |
...
| **Gate** | G2 |
| **Owner** | Product |
| **Intake 状態** | **Answered**（[#134](https://github.com/studio-prospect/qwon-ai-ios/pull/134)） |
...
**[intake 記録承認済](#product-decision-draft--awaiting-explicit-approval)** を参照 — intake **Answered**（[#134](https://github.com/studio-prospect/qwon-ai-ios/pull/134)）；historical at worksheet time: sign-off 前は **Open**；現在は **G2 Closed/Ready**（[#136](https://github.com/studio-prospect/qwon-ai-ios/pull/136)）。
...
| **制約** | 承認済み App Store 文案ではない；historical at worksheet time: G2 Closed/Ready ではない；現在は G2 Closed/Ready（[#136](https://github.com/studio-prospect/qwon-ai-ios/pull/136)） |
...
| **制約** | ASC upload なし；historical at worksheet time: G2 Closed/Ready ではない；現在は G2 Closed/Ready（[#136](https://github.com/studio-prospect/qwon-ai-ios/pull/136)） |
...
| **制約** | ローカライズ資産 upload 承認ではない；historical at worksheet time: G2 Closed/Ready ではない；現在は G2 Closed/Ready（[#136](https://github.com/studio-prospect/qwon-ai-ios/pull/136)） |
...
| follow-up docs-only PR で intake **Answered** | **Done** — [#134](https://github.com/studio-prospect/qwon-ai-ios/pull/134) |
| checklist G2 Closed/Ready | **Done** — [#136](https://github.com/studio-prospect/qwon-ai-ios/pull/136) |
| Public release approved | **No** |
...
G2 intake **Answered**（[#134](https://github.com/studio-prospect/qwon-ai-ios/pull/134)）。intake 記録だけでは公開承認、Build `4`、ASC upload、TestFlight ops は承認されず、現在の checklist gate **G2 Closed/Ready** は gate sign-off（[#136](https://github.com/studio-prospect/qwon-ai-ios/pull/136)）のみを正本とする。Stay 下の docs hygiene のみ。
