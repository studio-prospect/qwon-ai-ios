...
**Last updated:** 2026-06-04 (PR M1 merged + post-merge verification)
...
| **Scoped plan** | **[qwon_model_download_gguf_ux_plan.md](./qwon_model_download_gguf_ux_plan.md)** — M1 **merged** ([#86](https://github.com/studio-prospect/qwon-ai-ios/pull/86)); post-merge verification recorded |
| **Next agent step** | **M2 still gated** — guided placement not started; await Product/Codex gate |
...
| **Post-alpha: Model download / GGUF UX** | Lane selected; M1 merged | [Scoped plan](./qwon_model_download_gguf_ux_plan.md) · [Decision memo](./qwon_model_download_gguf_ux_decision.md) | **No default** — **M2 gated** |
...
| Plan Model download / GGUF UX | **M1 complete** ([#86](https://github.com/studio-prospect/qwon-ai-ios/pull/86)); **M2 gated** | [Scoped plan](./qwon_model_download_gguf_ux_plan.md#pr-m1-post-merge-verification-2026-06-04) · [Decision memo](./qwon_model_download_gguf_ux_decision.md) |
