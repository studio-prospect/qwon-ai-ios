...
**Last updated:** 2026-06-08 (Stay selected — G2 gate **Closed/Ready**)
...
| Field | Detail |
| --- | --- |
| **Status** | **Checklist + intake ledger** — G1 + G2 **Closed/Ready**; **18 Unanswered**; **public release not approved** |
| **Trigger** | Product plans **public App Store horizon** (separate from Build `4`) |
| **Required evidence** | **G3 worksheet preparation** / privacy nutrition labels (Q-AS-07 … Q-AS-08) — **no** submission or code |
| **Next stage** | **G3 worksheet preparation / privacy nutrition labels** · [intake G3](./qwon_app_store_public_readiness_intake.md#g3--privacy-nutrition-labels) |
| **First doc to read** | [Intake ledger — G3 privacy nutrition labels](./qwon_app_store_public_readiness_intake.md#g3--privacy-nutrition-labels) · [M3 network memo](./qwon_m3_network_device_expectation_memo.md) |
