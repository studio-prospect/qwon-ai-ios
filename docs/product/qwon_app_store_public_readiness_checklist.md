...
| **G2** | **App Store metadata and screenshots** | **Open** | Intake **Q-AS-04 … Q-AS-06 Answered** (This PR) · **gate sign-off still Open** · [intake G2](./qwon_app_store_public_readiness_intake.md#g2--app-store-metadata--screenshots--localization) · [G2 metadata worksheet](./qwon_app_store_g2_metadata_worksheet.md) · [日本語フォーム](./qwon_app_store_g2_metadata_worksheet_ja.md) |
