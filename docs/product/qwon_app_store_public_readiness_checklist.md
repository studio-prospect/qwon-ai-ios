...
| **G2** | **App Store metadata and screenshots** | **Open** | Intake **Q-AS-04 … Q-AS-06 Answered** (This PR) · [G2 worksheet — approved for intake recording](./qwon_app_store_g2_metadata_worksheet.md#product-decision-draft--awaiting-explicit-approval) · [日本語フォーム — intake 記録承認済](./qwon_app_store_g2_metadata_worksheet_ja.md#product-decision-draft--awaiting-explicit-approval) · **gate sign-off still Open** · [intake G2](./qwon_app_store_public_readiness_intake.md#g2--app-store-metadata--screenshots--localization) |
...
| **Next action** | **Product / Legal / RE review only** — **G2 gate sign-off worksheet preparation** · [intake G2](./qwon_app_store_public_readiness_intake.md#g2--app-store-metadata--screenshots--localization) (**18 Unanswered**) · **no** implementation or submission |
