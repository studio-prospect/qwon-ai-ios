...
| **Next action** | **Product / Legal / RE review only** — **G6 intake** (Q-AS-13 … Q-AS-15) when scoped · [intake G6](./qwon_app_store_public_readiness_intake.md#g6--support--website--terms--privacy-policy) (**12 Unanswered** overall) · **no** implementation or submission |
