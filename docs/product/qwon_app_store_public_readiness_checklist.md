...
| **Next action** | **Product / Legal / RE review only** — **G4 worksheet preparation / export compliance** · [intake G4](./qwon_app_store_public_readiness_intake.md#g4--export-compliance--encryption-declaration) (**16 Unanswered**) · **no** implementation or submission |
