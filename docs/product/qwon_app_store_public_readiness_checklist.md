...
| **G4** | **Export compliance / encryption declaration** | **Partial** | [Q-AS-09 … Q-AS-10](./qwon_app_store_public_readiness_intake.md#g4--export-compliance--encryption-declaration) · [G4 export compliance worksheet](./qwon_app_store_g4_export_compliance_worksheet.md) · [日本語フォーム](./qwon_app_store_g4_export_compliance_worksheet_ja.md) · [TestFlight prep — export compliance](./qwon_text_alpha_testflight_prep.md#export-compliance-operator-gate) |
...
| **Next action** | **Product / Legal / RE review only** — **G4 worksheet review / answer preparation** · [G4 export compliance worksheet](./qwon_app_store_g4_export_compliance_worksheet.md) · [intake G4](./qwon_app_store_public_readiness_intake.md#g4--export-compliance--encryption-declaration) (**16 Unanswered**) · **no** implementation or submission |
