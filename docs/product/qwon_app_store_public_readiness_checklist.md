...
| **G2** | **App Store metadata and screenshots** | **Open** | Intake **Q-AS-04 … Q-AS-06 Answered** ([#134](https://github.com/studio-prospect/qwon-ai-ios/pull/134)) · [G2 gate sign-off worksheet](./qwon_app_store_g2_gate_signoff_worksheet.md#sign-off-record-product) **Pending** · [G2 worksheet — approved for intake recording](./qwon_app_store_g2_metadata_worksheet.md#product-decision-draft--awaiting-explicit-approval) · [intake G2](./qwon_app_store_public_readiness_intake.md#g2--app-store-metadata--screenshots--localization) |
...
| **Next action** | **Product / Legal / RE review only** — **G2 sign-off decision** · [G2 gate sign-off worksheet](./qwon_app_store_g2_gate_signoff_worksheet.md#sign-off-record-product) · [intake G2](./qwon_app_store_public_readiness_intake.md#g2--app-store-metadata--screenshots--localization) (**18 Unanswered**) · **no** implementation or submission |
