...
| Step | Gate |
| --- | --- |
| **Bundle ID + signing** | **Blocking** — formal ID approved and ASC app created, but Xcode/scripts and Distribution signing are not yet aligned to `jp.studio-prospect.prexus.ios` ([prep doc](./qwen_text_only_alpha_testflight_prep.md#bundle-id-and-signing-gate-blocking-testflight)) |
