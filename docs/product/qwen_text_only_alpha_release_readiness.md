...
| Step | Gate |
| --- | --- |
| **Bundle ID + signing** | **Partial** — formal ID `jp.studio-prospect.prexus.ios`, ASC app, repo migration, and local provisioning profiles are recorded; Distribution archive / upload still open ([prep doc](./qwen_text_only_alpha_testflight_prep.md#bundle-id-and-signing-gate-blocking-testflight)) |
