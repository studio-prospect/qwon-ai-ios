...
#   - Apple Development signing for jp.studio-prospect.qwon.ios on your team
#
# Usage:
...
echo ""
echo "Done. On device, verify Chat (full checklist):"
echo "  docs/design/device_install_and_screenshot_workflow.md"
echo ""
echo "Quick checks:"
echo "  - Header + settings + composer (control-surface glass)"
echo "  - Type → Planned Route above composer"
echo "  - Send → Executing Route, then Executed Route"
echo "  - Latest messages scroll above composer / route banner"
echo "  - Message bubbles opaque; keyboard dismiss (tap / swipe / scroll)"
